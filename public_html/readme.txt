...
##IDEAS##
 - Properties javascript file; for each of the steps of the Graphical Projection process. Allow these values to be changed with a control panel.
 - Lighting
 - Texture
 - Physics
	- Collision detection
 ...
 - Re-factor code to make it more usable
 - Move the camera around the scene
 - Render League of Legends Character Models